...
//  static files, as well as providing a synchronizing utility (by serving
//  dynamic js "files" a la JsonP)
module.exports = {

  runServer: function(config) {
    ...
    // Multi-dyno setups aren't going to work.
    // Would need a database or reddis or the like if we want to scale it.
    var syncSessions = {};
    ...
    //  of that session (by calling the client-side function
    //  setSyncSessionId(), so it can be shared in order to make
    //  replicas.
    //
